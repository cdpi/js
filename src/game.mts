...
import type { Point, Rectangle } from "./geometry.mjs";
...
interface Randomizer
	{
	makeRandomPointInEachCell(columns:number, rows:number, cellSize:number, margin:number):Array<Array<Point>>
	}
...
class Map<T extends Rectangle> extends Grid implements Randomizer
	 ...
	 * @since 0.1.0
	 */
	public makeRandomPointInEachCell(columns:number, rows:number, cellSize:number, margin:number):Array<Array<Point>>
		{
